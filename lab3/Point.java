...
public class Point extends JComponent {
	 ...
	 *         If the line between the points is horizontal positive zero is
	 *         returned, If the line between the points is vertical positive
	 ...
	 * @return - boolean, true if this Point is the smaller of the two. False
	 *         otherwise.
	 */
	 ...
	 *
	 * @param p - The other Point to compare with.
	 * @return - boolean, true if this Point is the greater of the two. False
	 *         otherwise.
	 */
